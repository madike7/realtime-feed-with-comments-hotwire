// mono gia ta youtube embeds
// den to xrhsimopoiw kathws to embed.js prosferei perissotera embeds including youtube
      ...
      <div class="trix-dialog trix-dialog--link" data-trix-dialog="href" data-trix-dialog-attribute="href">
        <div class="trix-dialog__link-fields">
          ...
          <div class="flex">
            ...
            <input type="button" class="btn btn-light outline btn-small" value="${lang.unlink}" data-trix-method="removeAttribute">
          </div>
        </div>
        <div data-behavior="embed_container">
          <div class="link_to_embed link_to_embed--new">
            Would you like to embed media from this site?
            <input class="btn btn-info outline btn-small ms-3" type="button" data-behavior="embed_url" value="Yes, embed it">
          </div>
        </div>
      </div>
    </div>
