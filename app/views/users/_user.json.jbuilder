...
json.content render(partial: "users/user", locals: { user: user }, formats: [:html]) # otan kanw edit sti forma, kanw render to idio partial gia na deixnei akrivws to idio 
